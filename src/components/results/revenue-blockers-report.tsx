      ...
      <div className="grid gap-5 lg:grid-cols-[1fr_auto] lg:items-start">
        <div>
          ...
          <p className="mt-3 max-w-3xl text-base leading-8 text-slate-600">
            Dieser Bericht übersetzt den Check in konkrete Bremsen: was Besucher kostet, was zu tun ist und womit du anfangen solltest. Die Struktur ist bewusst PDF-freundlich vorbereitet.
          </p>
        </div>
