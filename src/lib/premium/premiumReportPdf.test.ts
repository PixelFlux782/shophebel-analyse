    ...
    const report: PremiumReport = {
      ...
      websiteAnalysis: {
        pages: [
          ...
          {
            url: "https://shop.test/sortiment",
            label: "Sortiment",
            role: "product",
            reason: "Produkt-Signal",
            analysisStatus: "analyzed",
            screenshotUrl: "https://cdn.example.com/screenshots/kontakt.png",
            score: 76,
            strengths: ["Angebot sichtbar"],
            problems: ["CTA uneinheitlich"],
            recommendation: "CTA-Fuehrung vereinheitlichen.",
            shortDiagnosis: "Sortimentsseite mit CTA-Hebel.",
          },
        ],
