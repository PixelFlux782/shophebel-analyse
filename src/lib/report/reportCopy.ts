...
export const REPORT_LABELS = {
  premiumReportTitle: "Dein Premium-Bericht",
...
export const CUSTOMER_FORBIDDEN_REPLACEMENTS = {
  ...
  "Premium Report": "Premium-Bericht",
  "Full Report": "Vollanalyse",
  "Full Analysis": "Vollanalyse",
  "Critical Signals": "Wichtige Warnsignale",
  "Analysis complete": "Analyse abgeschlossen",
  "Rendered live scan": "Live-Ansicht geprüft",
  "Visual / UX / SEO / AI calibrated": "Visuelle Prüfung, Nutzerführung, Auffindbarkeit und KI-Sichtbarkeit eingeordnet",
  "Button-Weg stable": "Handlungsweg erkennbar, aber noch nicht klar genug",
  "watch friction": "Reibung prüfen",
  "below optimal range": "unter dem empfohlenen Bereich",
